        ...
        <>
            <div className={`container ${prop.darkMode ? "dark" : "light"}-mode`} >
                <div className='container'>
                    ...
                    <div className="btn btn-primary mx-1 my-1" onClick={HandleUpKey}>Convert to Uppercase</div>
                    <div className="btn btn-primary mx-1 my-1" onClick={HandleLoKey}>Convert to Lowecase</div>
                    <div className="btn btn-primary mx-1 my-1" onClick={LongWord}>Longest Word Length</div>
                    <div className="btn btn-primary mx-1 my-1" onClick={Speak}>Speak</div>
                    <div className="btn btn-success mx-1 my-1" onClick={CopyToClipboard}>Copy</div>
                    <div className="btn btn-warning mx-1 my-1" onClick={ClaerText}>Clear</div>
                </div>
